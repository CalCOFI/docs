...
The [Integrated App](https://app.calcofi.io/db-viz-hex) download bundle uses the same
...
**[CalCOFI Query](https://calcofi.io/db-query/)** and it returns identical rows. That is the contract
behind the [Integrated App](https://app.calcofi.io/db-viz-hex) download bundle's
`query/` folder.
...
| **your web browser**, no install | **[CalCOFI Query](https://calcofi.io/db-query/)** — point-and-click form for the three wrappers + custom SQL + a free-form SQL shell, all running DuckDB-WASM client-side |
