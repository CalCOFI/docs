...
**[CalCOFI Query](https://calcofi.io/query/)** and it returns identical rows. That is the contract
...
| **your web browser**, no install | **[CalCOFI Query](https://calcofi.io/query/)** — point-and-click form for the three wrappers + custom SQL + a free-form SQL shell, all running DuckDB-WASM client-side |
