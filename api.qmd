...
now an interactive form at **[calcofi.io/query/](https://calcofi.io/query/)**
...
|---|---|---|
| `/variables` | `cc_list_measurement_types()` | [Query → measurement types](https://calcofi.io/query/#browse--measurement-types) |
| `/timeseries` | direct SQL aggregation — see [Data Access](data-access.qmd) | [Query → SQL shell](https://calcofi.io/query/#sql-shell--shell) |
| `/cruises` | `cc_read_cruise()` | [Query → cruises](https://calcofi.io/query/#browse--cruises) |
| `/raster` | direct SQL + `pts_to_rast_idw()` | — |
| `/cruise_lines`, `/cruise_line_profile` | direct SQL against `ctd_cast` / `ctd_thin` | [Query → SQL shell](https://calcofi.io/query/#sql-shell--shell) |
| `zooplankton_biomass` | [`cc_match_zooplankton_biomass()`](helpers.qmd) | **[Query → zoo biomass](https://calcofi.io/query/#bio-env-matching--zoo-biomass)** |
| `itis_ichthyodata` | [`cc_match_ichthyo_by_taxon()`](helpers.qmd) | **[Query → by taxon](https://calcofi.io/query/#bio-env-matching--by-taxon)** |
| `ichthyodata` | [`cc_match_ichthyo_by_name()`](helpers.qmd) | **[Query → by name](https://calcofi.io/query/#bio-env-matching--by-name)** |
