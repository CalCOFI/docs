...
All datasets are ingested using a single master Quarto script [`calcofi4db/inst/ingest.qmd`](https://github.com/CalCOFI/calcofi4db/blob/main/inst/ingest.qmd) that:
