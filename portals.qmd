...
-   How to cite the CalCOFI Integrated Database release, and how to cite an
    individual dataset within it — checked citations, licenses and DOIs, one
    row per dataset
-   `cc_cite()` in `calcofi4r` / `calcofi4py`, for citing exactly the
    datasets a query touched
-   Link:
