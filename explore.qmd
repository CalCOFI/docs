...
- **Basemap labels** — the basemap's own place names, road names, points of interest and water
  ...
  `basemapo=`); off (`basemap=nolabels`) for a data-centric view, with the isobath labels and the
  undersea feature names untouched. The names layer has its own opacity in its *On the map* row.
