...
- To **see what's in each table** before writing a query, open the
  [**CalCOFI Schema explorer**](https://calcofi.io/schema/) — ERD,
...
form at **→ [Open CalCOFI Query](https://calcofi.io/query/)** that wraps the three retired
...
| **your web browser**, no install | **[CalCOFI Query](https://calcofi.io/query/)** — point-and-click form, runs DuckDB-WASM client-side |
...
`attr(x, "sql")`, what the browser-based **[CalCOFI Query](https://calcofi.io/query/)** generates as
