...
(workflows, calcofi4db, calcofi4r, server, docs, int-app, apps, query, erddap,
...
- **Management areas of interest.** The integrated app (`int-app`) gained spatial layers for maritime zones, marine protected areas, and wind energy areas, plus a dark/light theme, reproducible query/data download bundles, and a direct connection to the `calcofi4r` Parquet database (replacing the old API dependency).
...
| Deliverable | Status |
|---|---|
| Add management areas (sanctuaries, MPAs, wind areas) | ✅ added to int-app |
